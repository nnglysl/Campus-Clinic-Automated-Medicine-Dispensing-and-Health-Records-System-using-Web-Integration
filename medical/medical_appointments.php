...
$user = [
    'id' => $_SESSION['user_id'],
    'fname' => $_SESSION['fname'] ?? 'Dentist',
    'lname' => $_SESSION['lname'] ?? '',
    'role' => $_SESSION['role'] ?? 'dentist',
    'full_name' => ($_SESSION['fname'] ?? 'Dentist') . ' ' . ($_SESSION['lname'] ?? '')
];
        ...
        card.innerHTML = `
          ...
          <div class="appointment-actions">
            ${apt.status === 'scheduled' ? `
              <button class="btn-sm btn-confirm" onclick="updateStatus(${apt.id}, 'confirmed')">
