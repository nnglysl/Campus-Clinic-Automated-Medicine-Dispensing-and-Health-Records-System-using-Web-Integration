...
<head>
  ...
  <link rel="stylesheet" href="../medical/css/medical_dashboard.css" />
...
<body>
  ...
  <div class="main-container">
    <!-- Sidebar -->
    <div class="sidebar">
      <a href="../medical/medical_dashboard.php" class="menu-item active">Dashboard</a>
          ...
          <div class="calendar-panel">
            ...
            <div class="appointments-card">
              <div class="appointments-header">
                <div>
                  <h5>Appointments</h5>
                  <p class="selected-date-label" id="selectedDateLabel">All Medical Appointments</p>
                </div>
  ...
  <script>
    (() => {
      ...
      const appointmentType = 'medical'; // Filter for medical appointments only
    ...
    function showAppointmentsForDate(dateIso) {
      ...
      if (dateIso) {
        ...
        selectedDateLabel.textContent = 'All Medical Appointments';
      }
...
function setupLazyLoading() {
  // Use Intersection Observer for low stock cards
  ...
  // Use Intersection Observer for expiring items cards
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (window.requestIdleCallback) {
    ...
    // Fallback: small delay for better performance
