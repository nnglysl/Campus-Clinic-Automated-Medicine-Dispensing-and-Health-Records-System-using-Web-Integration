...
$fullName = $user_name; // ✅ define $fullName to avoid warning
$user_role = $_SESSION['role'] ?? 'patient';

// ✅ Redirect if unauthorized (only admin, doctor, and dentist can access)
if (!in_array($user_role, ['admin', 'doctor', 'dentist'])) {
...
<body>
  ...
  <div class="main-container">
    ...
    <div class="sidebar">
      ...
      <a href="../medical/settings.php" class="menu-item">Settings</a>
