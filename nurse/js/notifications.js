/**
 * Notification System for Nurse Pages
 */
...
(function() {
    ...
    function handleNotificationClick(type, data) {
        // For medicine alerts, navigate to inventory page
        if (type === 'low_stock' || type === 'nearing_expiry' || type === 'expired') {
            window.location.href = '../admin/inventory.php';
        }
    }
    
    window.NurseNotificationSystem = {
        init: init,
