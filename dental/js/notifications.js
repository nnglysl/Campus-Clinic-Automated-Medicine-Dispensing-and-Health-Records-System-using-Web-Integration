/**
 * Notification System for Dental Pages
 */
...
(function() {
    ...
    function handleNotificationClick(type, data) {
        ...
        if (type === 'appointment_booked' && data.appointment_type === 'dental') {
            window.location.href = 'dental_appointments.php';
        }
    }
    
    window.DentalNotificationSystem = {
        init: init,
